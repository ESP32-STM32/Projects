...
/*
  ...
  INA226_MODE_POWER_DOWN // Отключение модуля
  INA226_MODE_SHUNT_CONT // Включить измерение только ТОКА
  INA226_MODE_BUS_CONT // Включить измерение только НАПРЯЖЕНИЯ
  INA226_MODE_SHUNT_BUS_CONT // Включить измерение ТОКА и НАПРЯЖЕНИЯ
*/
